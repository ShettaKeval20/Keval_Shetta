    ...
    <section className="relative bg-[#0d1117] min-h-screen px-4 sm:px-6 py-10 sm:py-20 text-white">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 relative z-10">
        ...
        <motion.div
          ...
          className="md:col-span-8 space-y-10 sm:space-y-12 order-2 md:order-1"
        >
          {/* Approach */}
        ...
        <motion.aside
          ...
          className="md:col-span-4 bg-[#161b22]/70 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-lg border border-gray-700 order-1 md:order-2"
        >
