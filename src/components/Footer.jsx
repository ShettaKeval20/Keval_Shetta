...
import useDeviceType from "../hooks/useDeviceType"; // ✅ Make sure path is correct

// Earth Model
function EarthModel() {
  const isMobile = useDeviceType();
  const gltf = useGLTF(isMobile ? "/models/earth_mobile.glb" : "/models/earth.glb");

  return (
    <group>
      <primitive object={gltf.scene} scale={3.0} position={[0, -1.2, 0]} />
    </group>
  );
}
...
useGLTF.preload("/models/earth_mobile.glb");
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 z-10 relative">
        ...
        <div className="text-center md:text-left space-y-6 flex-1">
          ...
          <div className="flex justify-center md:justify-start gap-6 text-gray-400 text-2xl">
            <a href="https://github.com/ShettaKeval20" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-transform hover:scale-110">
              <FaGithub />
            </a>
            <a href="https://www.linkedin.com/in/kevalshetta/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-transform hover:scale-110">
              <FaLinkedin />
            </a>
            <a href="mailto:kevalshetta@gmail.com" className="hover:text-white transition-transform hover:scale-110">
              <FaEnvelope />
            </a>
          </div>
